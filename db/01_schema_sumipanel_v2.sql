-- =============================================================
-- SUMIPANEL ADMIN — Schema completo (orden correcto)
-- Version 2: funciones y triggers van AL FINAL
-- =============================================================

set search_path = sumipanel, public;

-- =============================================================
-- 1. TABLAS (primero todo lo que se referencia)
-- =============================================================
...
-- =============================================================
-- 2. FUNCIONES HELPERS (AHORA que las tablas ya existen)
-- =============================================================
...
-- Trigger para crear perfil SUMIPANEL al registrarse
...
where table_schema = 'sumipanel' order by table_name;

select 'Schema SUMIPANEL instalado correctamente' as status;
